...
app = Flask(__name__)
app.secret_key = 'your secret is safe with me!'
...
def outfits():
    if request.method=="GET":
        ...
        time= datetime.now()
        formatted_date = time.strftime("%c")
        #print("time1", formatted_date)
        ...
        return render_template('outfits.html', city=submitted_city, result=result, time=formatted_date, randomInt=random_num, coldFootwear=cold_footwear,
